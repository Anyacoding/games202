function getRotationPrecomputeL(precompute_L, rotationMatrix) {
	...
	for(let i = 0; i < 3; i++) {
        let L_SH_R_3 = math.multiply(shRotateMatrix3x3, [precompute_L[1][i], precompute_L[2][i], precompute_L[3][i]]);
        let L_SH_R_5 = math.multiply(shRotateMatrix5x5, [precompute_L[4][i], precompute_L[5][i], precompute_L[6][i], precompute_L[7][i], precompute_L[8][i]]);
